...
const translations = {
  de: {
    ...
    about_p1: 'Ich habe Neomind aus einem sturen, ein bisschen peinlichen Grund gebaut: Ich hatte es satt, dass meine Affirmationen auf einem Stapel handgeschriebener Karten lagen.',
    ...
    about_p6: 'Ich will, dass es die innere Arbeit leicht macht. Dass es die Praxis, die im Stillen alles verändert, nimmt und jede Ausrede beseitigt, sie nicht zu tun. Keine chaotischen Karten. Keine Schreibblockade vor dem leeren Blatt. Öffne einfach die App, und die Version von dir, die du gerade wirst, ist direkt da, nur einen Swipe entfernt.',
    ...
    about_p8: 'Und ehrlich gesagt will ich, dass es sich anfühlt, als wäre es von einem echten Menschen gemacht, dem es wichtig ist, ob es für dich funktioniert. Denn das war es.',
